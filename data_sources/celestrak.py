...
_SEED_RAW = [
    ...
    # === WGS (US Military Comms) – GEO ===
    ('WGS-1 (USA 195)', 'WGS-1', 32258, 0.05, 1.00274, 0.0003, 0.0, 60.0, 120.0, 240.0, 'PAYLOAD'),
    ('WGS-2 (USA 204)', 'WGS-2', 33153, 0.06, 1.00273, 0.0002, 0.0, 12.0, 200.0, 160.0, 'PAYLOAD'),
    ('WGS-3 (USA 211)', 'WGS-3', 36107, 0.04, 1.00275, 0.0003, 0.0, 178.0, 90.0, 270.0, 'PAYLOAD'),
    ('WGS-4 (USA 233)', 'WGS-4', 38070, 0.05, 1.00274, 0.0002, 0.0, 250.0, 150.0, 210.0, 'PAYLOAD'),
    ('WGS-5 (USA 243)', 'WGS-5', 39168, 0.03, 1.00274, 0.0002, 0.0, 325.0, 80.0, 130.0, 'PAYLOAD'),
    ('WGS-6 (USA 244)', 'WGS-6', 39222, 0.04, 1.00273, 0.0003, 0.0, 100.0, 260.0, 30.0, 'PAYLOAD'),
    ('WGS-7 (USA 263)', 'WGS-7', 41879, 0.05, 1.00275, 0.0002, 0.0, 145.0, 310.0, 50.0, 'PAYLOAD'),
    ('WGS-8 (USA 272)', 'WGS-8', 42696, 0.06, 1.00274, 0.0003, 0.0, 220.0, 40.0, 320.0, 'PAYLOAD'),
    ('WGS-9 (USA 275)', 'WGS-9', 43128, 0.04, 1.00273, 0.0002, 0.0, 290.0, 170.0, 90.0, 'PAYLOAD'),
    ('WGS-10 (USA 291)', 'WGS-10', 44478, 0.05, 1.00275, 0.0003, 0.0, 355.0, 220.0, 140.0, 'PAYLOAD'),
    # === AEHF (US Protected Comms) – GEO ===
    ('AEHF-1 (USA 214)', 'AEHF-1', 36868, 0.08, 1.00274, 0.0003, 0.0, 50.0, 100.0, 260.0, 'PAYLOAD'),
    ('AEHF-2 (USA 235)', 'AEHF-2', 38232, 0.06, 1.00273, 0.0002, 0.0, 120.0, 200.0, 60.0, 'PAYLOAD'),
    ('AEHF-3 (USA 246)', 'AEHF-3', 39476, 0.07, 1.00275, 0.0003, 0.0, 200.0, 300.0, 150.0, 'PAYLOAD'),
    ('AEHF-4 (USA 288)', 'AEHF-4', 43651, 0.05, 1.00274, 0.0002, 0.0, 280.0, 50.0, 310.0, 'PAYLOAD'),
    # === SBIRS (US Missile Warning) – GEO ===
    ('SBIRS GEO-1 (USA 230)', 'SBIRS-1', 37481, 0.08, 1.00274, 0.0003, 0.0, 75.0, 130.0, 230.0, 'PAYLOAD'),
    ('SBIRS GEO-2 (USA 241)', 'SBIRS-2', 38953, 0.06, 1.00273, 0.0002, 0.0, 150.0, 230.0, 50.0, 'PAYLOAD'),
    ('SBIRS GEO-3 (USA 273)', 'SBIRS-3', 43031, 0.07, 1.00275, 0.0003, 0.0, 230.0, 330.0, 130.0, 'PAYLOAD'),
    ('SBIRS GEO-4 (USA 282)', 'SBIRS-4', 43470, 0.05, 1.00274, 0.0002, 0.0, 310.0, 70.0, 290.0, 'PAYLOAD'),
    ('SBIRS GEO-5 (USA 315)', 'SBIRS-5', 49516, 0.04, 1.00274, 0.0003, 0.0, 35.0, 170.0, 180.0, 'PAYLOAD'),
    # === GSSAP (US Space Surveillance) – near-GEO ===
    ('GSSAP-1 (USA 253)', 'GSSAP-1', 40353, 0.5, 1.00280, 0.0005, 0.0, 90.0, 60.0, 300.0, 'PAYLOAD'),
    ('GSSAP-2 (USA 254)', 'GSSAP-2', 40354, 0.5, 1.00280, 0.0005, 0.0, 180.0, 160.0, 200.0, 'PAYLOAD'),
    ('GSSAP-3 (USA 270)', 'GSSAP-3', 42510, 0.5, 1.00280, 0.0005, 0.0, 270.0, 260.0, 100.0, 'PAYLOAD'),
    ('GSSAP-4 (USA 271)', 'GSSAP-4', 42511, 0.5, 1.00280, 0.0005, 0.0, 355.0, 350.0, 10.0, 'PAYLOAD'),
    # === NROL / USA ISR (US Reconnaissance) – various ===
    ('USA 245 (NROL-65)', 'NROL-65', 39232, 97.9, 14.58, 0.0012, 0.0001, 40.0, 290.0, 70.0, 'PAYLOAD'),
    ('USA 290 (NROL-71)', 'NROL-71', 44331, 97.9, 14.58, 0.0011, 0.0001, 130.0, 100.0, 260.0, 'PAYLOAD'),
    ('USA 314 (NROL-82)', 'NROL-82', 48859, 63.4, 14.40, 0.0008, 0.0001, 220.0, 50.0, 150.0, 'PAYLOAD'),
    ('USA 326 (NROL-87)', 'NROL-87', 51582, 97.4, 15.19, 0.0010, 0.0001, 310.0, 200.0, 340.0, 'PAYLOAD'),
    ('USA 338 (NROL-91)', 'NROL-91', 54234, 97.9, 14.58, 0.0012, 0.0001, 180.0, 320.0, 40.0, 'PAYLOAD'),
    # === MUOS (US Mobile Comms) – GEO ===
    ('MUOS-1 (USA 243B)', 'MUOS-1', 38908, 0.06, 1.00274, 0.0003, 0.0, 170.0, 110.0, 250.0, 'PAYLOAD'),
    ('MUOS-2 (USA 252)', 'MUOS-2', 39363, 0.05, 1.00273, 0.0002, 0.0, 250.0, 210.0, 150.0, 'PAYLOAD'),
    ('MUOS-3 (USA 259)', 'MUOS-3', 40374, 0.07, 1.00275, 0.0003, 0.0, 330.0, 10.0, 350.0, 'PAYLOAD'),
    ('MUOS-4 (USA 264)', 'MUOS-4', 41622, 0.04, 1.00274, 0.0002, 0.0, 50.0, 310.0, 90.0, 'PAYLOAD'),
    # === SKYNET (UK Military Comms) – GEO ===
    ('SKYNET 5A', 'SKY-5A', 30794, 0.06, 1.00274, 0.0003, 0.0, 5.0, 180.0, 180.0, 'PAYLOAD'),
    ('SKYNET 5B', 'SKY-5B', 33055, 0.05, 1.00273, 0.0002, 0.0, 25.0, 270.0, 90.0, 'PAYLOAD'),
    ('SKYNET 5C', 'SKY-5C', 36795, 0.04, 1.00275, 0.0003, 0.0, 355.0, 60.0, 300.0, 'PAYLOAD'),
    ('SKYNET 5D', 'SKY-5D', 38011, 0.07, 1.00274, 0.0002, 0.0, 53.0, 150.0, 210.0, 'PAYLOAD'),
